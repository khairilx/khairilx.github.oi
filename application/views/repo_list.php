            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  $author = $this->db->query("SELECT * FROM authors WHERE id = '$repository->id_author'")->row()->author;
                  $type = $this->db->query("SELECT * FROM types WHERE id = '$repository->id_type'")->row()->type;
