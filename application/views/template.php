...
<head>
  ...
  <title>Administrasi Repository</title>
...
<body class="hold-transition skin-red sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="<?= base_url() ?>prodi"><i class="fa fa-book"></i> <span>Prodi </span></a></li>
          <li><a href="<?= base_url() ?>types"><i class="fa fa-book"></i> <span>Metode </span></a></li>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; <?php echo date('Y'); ?>.</strong> Sekolah Tinggi Agama Islam Nurul Ilmi Tanjung Balai.
    </footer>
